    ...
    <>
      ...
      <aside
        ...
        className={cn(
          ...
          'dashboard-drawer fixed right-0 top-0 z-50 h-dvh w-[360px] max-w-full flex flex-col transition-transform duration-300 ease-in-out',
      ...
      >
        ...
        <div className="dashboard-drawer-header flex items-center justify-between p-5 border-b border-border/10">
          <div className="flex items-center gap-2">
            ...
            {onlineCount > 0 && (
              <span className="h-5 px-1.5 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold rounded-full flex items-center">
